...
data_dir = '/media/662CD4C02CD48D05/_backup/raw_data/road_test_4/';
...
output_dir = '/media/662CD4C02CD48D05/_backup/data/images/road_test_4_mix/';
...
for idx = 3:length(all_files)
    ...
    cmd = ['/home/dontloo/Desktop/re/lib/segment/segment 0.8 100 100 ' tmp_dir out_name ' ' output_dir out_name];
